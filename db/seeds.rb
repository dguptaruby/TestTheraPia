...
Country.create(contry_name: 'IN')
Country.create(contry_name: 'Canada')
Country.create(contry_name: 'USA')
...
Company.create(company_name: 'Company 1', country: Country.last, state: State.last, city: City.last)
Company.create(company_name: 'Company 1', country: Country.second, state: State.second, city: City.second)
Company.create(company_name: 'Company 1', country: Country.third, state: State.third, city: City.third)
